...
public class RunAutomationDetails {
     ...
     */
    @JsonProperty("id")
    @JsonPropertyDescription("A hierarchical string that uniquely identifies this object's containing run object.")
    private String id;
    /**
     ...
     */
    @JsonProperty("guid")
    @JsonPropertyDescription("A stable, unique identifer for this object's containing run object in the form of a GUID.")
    private String guid;
    /**
    ...
    @JsonPropertyDescription("A stable, unique identifier for the equivalence class of runs to which this object's containing run object belongs in the form of a GUID.")
